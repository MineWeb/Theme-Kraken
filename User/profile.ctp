<div id="heading-breadcrumbs">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1 style="margin-top: -15px;color: white;text-transform: uppercase;font-family: 'Source Sans Pro', sans-serif;">
                    <img src="<?= $this->Html->url(array('controller' => 'API', 'action' => 'get_head_skin', $user['pseudo'], '90')) ?>"
                         alt="avatar"> <?= $user['pseudo'] ?></h1>
            </div>
            <div class="col-md-5">
                <ul style="margin-top: 18px;text-align: right;">
                    <a href="/shop" class="btn-panier btn"><i class="fa fa-shopping-cart"></i> Créditer mon compte</a>
                    <a href="<?= $this->Html->url(array('controller' => 'user', 'action' => 'logout', 'plugin' => null)) ?>"
                       class="btn-credits btn"><i class="fa fa-sign-out"></i> Déconnexion</a>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="input-profil form-control" value="<?= $user['pseudo'] ?>"
                                       disabled>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="input-profil form-control" value="<?= $user['email'] ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="input-profil form-control" value="<?= $user['ip'] ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="input-profil form-control"
						...
						<?php if ($EyPlugin->isInstalled('eywek.shop')) { ?>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="input-profil form-control" value="<?= $user['money'] ?>"
                                           disabled>
                                </div>
                            </div>
						<?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="input-profil form-control"
                                           name="password_confirmation">
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <button type="submit" class="btn-send-profil btn btn-template-main"><i
                                        class="fa fa-save"></i> <?= $Lang->get('GLOBAL__SUBMIT') ?></button>
                        </div>
                    </form>
                </div>
				...
				<?php if ($EyPlugin->isInstalled('eywek.shop')) { ?>
                    <div class="box clearfix no-mb">
                        ...
                        <form method="post" data-ajax="true"
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn-send-profil btn btn-template-main"><i
                                            class="fa fa-share"></i> <?= $Lang->get('GLOBAL__SUBMIT') ?></button>
                            </div>
                        </form>
                    </div>
				<?php } ?>
				<?php if ($Configuration->getKey('mineguard') == "true") { ?>
                    <div class="box clearfix no-mb">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form method="post" data-ajax="true"
                                      action="<?= $this->Html->url(array('controller' => 'api', 'action' => 'add_ip')) ?>"
                                      data-callback-function="addIP">
                                    <div class="form-group">
                                        <input type="text" class="input-profil form-control" name="ip"
                                               placeholder="<?= $Lang->get('IP') ?>">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit"
                                                class="btn-send-profil btn btn-success"><?= $Lang->get('GLOBAL__ADD') ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
				...
				<?php if ($can_skin) { ?>
                    <div class="box clearfix no-mb">
                        ...
                        <form class="form-inline" method="post" id="skin" method="post" data-ajax="true"
                            ...
                            <button type="submit"
                                    class="btn-send-profil btn btn-template-main"><?= $Lang->get('GLOBAL__SUBMIT') ?></button>
                        </form>
                    </div>
				<?php } ?>
				<?php if ($can_cape) { ?>
