...
<div id="heading-breadcrumbs">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <h1 style="margin-top: -15px;color: white;text-transform: uppercase;font-family: 'Source Sans Pro', sans-serif;"><img src="<?= $this->Html->url(array('controller' => 'API', 'action' => 'get_head_skin', $user['pseudo'], '90')) ?>" alt="avatar">  <?= $user['pseudo'] ?></h1>
      </div>
      <div class="col-md-5">
        <ul style="margin-top: 18px;text-align: right;">
          ...
          <a href="<?= $this->Html->url(array('controller' => 'user', 'action' => 'logout', 'plugin' => null)) ?>" class="btn-credits btn"><i class="fa fa-sign-out"></i> Déconnexion</a>
        </ul>
      </div>
    </div>
  </div>
