                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="post" enctype="multipart/form-data" data-ajax="false">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name_server" value="<?= $config['name_server'] ?>">
                                      </div>                                      
                                      ...
                                      <div class="form-group">
                                        <label>Image d'accueil (Fond) <small>Mettre lien de votre img</small></label>
                                        <input type="text" class="form-control" name="img_home" value="<?= $config['img_home'] ?>">
                                      </div>                                      
                                      ...
                                      <div class="form-group">
                                        <label>Nombres de particules <small>0 pour les desactiver (Par default 150)</small></label>
                                        <input type="text" class="form-control" name="particles_type" value="<?= $config['particles_type'] ?>">
                                      </div>

                                      <div class="form-group">
                                        <label>Couleur des particules</label>
                                        <small>Metter la couleur en hexadecimal (ex: #fff (blanc)</small>
                                        <input type="text" class="form-control" name="particles_color" value="<?= $config['particles_color'] ?>">
                                      </div>
                                      ...
                                      <div class="form-group">
                                        <label>Titre</label>
                                        <input type="text" class="form-control" name="title_banner" value="<?= $config['title_banner'] ?>">
                                      </div>

                                      <div class="form-group">
                                        <label>Texte bouton</label>
                                        <input type="text" class="form-control" name="name_button" value="<?= $config['name_button'] ?>">
                                        <label>Icone <small>(fa- ?)</small></label>
                                        <input type="text" class="form-control" name="fa_banner" value="<?= $config['fa_banner'] ?>">                                        
                                      </div>

                                      <div class="form-group">
                                        <label>Lien du bouton</label>
                                        <input type="text" class="form-control" name="link_banner" value="<?= $config['link_banner'] ?>">
                                      </div>                                      
                                ...
                                <div class="col-lg-6">
                                      ...
                                      <div class="form-group">
                                        <label>Titre</label>
                                        <input type="text" class="form-control" name="titre_article" value="<?= $config['titre_article'] ?>">
                                      </div>

                                      <div class="form-group">
                                        <label>Texte</label>
                                          <textarea class="form-control" name="texte_article" rows="3"><?= $config['texte_article'] ?></textarea>                             
                                      </div>

                                      <div class="form-group">
                                        <label>Image <small>Mettre le lien de l'image</small></label>
                                        <input type="text" class="form-control" name="img_article" value="<?= $config['img_article'] ?>">
                                      </div> 

                                      <div class="form-group">
                                        <label>Titre image</label>
                                        <input type="text" class="form-control" name="titre_img" value="<?= $config['titre_img'] ?>">
                                      </div> 

                                       <div class="form-group">
                                        <label>Texte image</label>
                                        <input type="text" class="form-control" name="text_img" value="<?= $config['text_img'] ?>">
                                      </div> 
