...
<div id="heading-breadcrumbs">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
          <h1 class="points-banner"> <?= $Lang->get('SUPPORT') ?></h1>
      </div>
      <div class="col-md-5">
        <?php if($isConnected AND $Permissions->can('POST_TICKET')) { ?>
          <button data-toggle="modal" data-target="#post_ticket" style="margin-top:15px;" class="btn-send-profil btn btn-template-main transparent btn-block"><icon class="fa fa-pencil-square-o"></icon> <?= $Lang->get('POST_A_TICKET') ?></button>
        <?php } ?>
      </div>
    </div>
  </div>
                  ...
                  <div class="col-md-12" id="ticket-<?= $value['Ticket']['id'] ?>">
                    <div class="content-ticket panel panel-primary">
                      <div class="panel-body">
                        <h3 style="font-family: 'Source Sans Pro', sans-serif;text-transform: uppercase;" class="support">
