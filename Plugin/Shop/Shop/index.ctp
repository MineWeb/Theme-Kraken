    ...
    <div class="row">
      ...
      <div class="col-md-5">
        <ul style="margin-top: 18px;text-align: right;">
          <a href="#" data-toggle="modal" data-target="#cart-modal" class="btn-panier btn"><i class="fa fa-shopping-cart"></i> <?= $Lang->get('SHOP__BUY_CART') ?></a>
          <a href="#" data-toggle="modal" data-target="#addmoney" class="btn-credits btn"><i class="fa fa-credit-card"></i> <?= $Lang->get('SHOP__ADD_MONEY') ?></a>
        </ul>
      </div>
    </div>
  </div>
            ...
            <div class="list-group">
              ...
              foreach ($search_categories as $category_link) {
                $i++;
                  ...
                  echo '<a class="list-group-item category-shop" href="'.$this->Html->url(array('controller' => 'c/'.$category_link['Category']['id'], 'plugin' => 'shop')).'">';
...
<!-- <div class="container" style="margin-top: 30px;margin-bottom: 30px;">
        <div class="row">
            <div class="col-md-3">
                <div class="list-group">
                    <a href="#" class="list-group-item category-shop">Category 1</a>
                    <a href="#" class="list-group-item category-shop">Category 2</a>
                    <a href="#" class="list-group-item category-shop">Category 3</a>
                </div>
            </div> -->
                ...
                echo '<div style="margin-bottom:30px;" class="product">';
                  ...
                  echo '<div class="image">';
                    echo '<a href="#" class="display-item" data-item-id="'.$item['id'].'">';
                      ...
                      echo $this->Html->image($url, array('class' => 'produit-shop img-responsive image1 img-shop', 'width' => '450', 'height' => '450'));
                    echo '</a>';
                  echo '</div>';

                  echo '<div class="text">';
                    echo '<h3 class="title-card-shop" style="color:black!important;"><a href="#" class="display-item" data-item-id="'.$item['id'].'">'.$item['name'].'</a></h3>';
                    echo '<p class="points-shop"> '.$item['price'].' '.$Configuration->getMoneyName().' </p>';
                    echo '<p class="buttons">';
                      echo '<a href="#" class="btn-buy btn display-item" data-item-id="'.$item['id'].'">'.$Lang->get('SHOP__BUY').'</a>';
                    echo '</p>';
                  echo '</div>';
