   ...
   <?= @$this->Session->flash(); ?>
            ...
            <div class="forum-forum">
                <div class="forum-forum-header">
                    <p class="forum-forum-title inline">
                        ...
                        <?php else: ?>
                            <i class="fa fa-forum fa-<?= $forum['Forum']['forum_image']; ?> forum-category-fa-min" aria-hidden="true"></i>
                        <?php endif; ?>
                    ...
                    <div class="forum-category">
                        <div class="row">
                            <div class="forum-category-icone col-xs-2 col-md-1 text-center">
                                ...
                                <?php else: ?>
                                    <i class="fa fa-forum fa-<?= $forum['Forum']['forum_image']; ?> forum-category-fa" aria-hidden="true"></i>
                                <?php endif; ?>
                            </div>
        ...
        <div class="col-md-4">
			<ol class="forum-breadcrumb">
                <?php if($perms['FORUM_VIEW_REPORT']): ?>
                    <li class="forum-left">
                        <a href="/forum/report"><i class="fa fa-forum fa-flag" aria-hidden="true"></i></a>
                    </li>
                <?php endif; ?>
                <?php if($active['privatemsg'] && isset($_SESSION['user'])): ?>
                    <li class="forum-left">
                        <a href="/message"><i class="fa fa-forum fa-envelope-o" aria-hidden="true"></i></a>
                    </li>
                <?php endif; ?>
                <?php if(isset($_SESSION['user'])): ?>
                    <li class="forum-left">
                        <a href="/user/<?= $my['user']; ?>.<?= $my['id']; ?>/"><i class="fa fa-forum fa-user" aria-hidden="true"></i></a>
                    </li>
                    <li class="forum-left last">
                        <a href="/user/logout"><i class="fa fa-forum fa-sign-out" aria-hidden="true"></i></a>
                    </li>
                <?php else: ?>
                    <li class="forum-left last">
                        <a href="#" data-toggle="modal" data-target="#login"><i class="fa fa-forum fa-sign-in" aria-hidden="true"></i></a>
                    </li>
                <?php endif; ?>
            </ol>
    ...
    <?php if($active['statistics']): ?>
        ...
        <div class="forum-other-header">
            <p class="forum-forum-title"><i class="fa fa-forum fa-bar-chart" aria-hidden="true"></i> <?= $Lang->get('FORUM__STATISTIC'); ?></p>
        </div>
        <div class="forum-category">
            <div class="row">
