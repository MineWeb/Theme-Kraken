...
<?= $this->fetch('content'); ?>
	...
	<footer class="page-footer">
      ...
      ?>
		...
		<p class="propulse-footer">Propulsé par <span class="cms-name"><a href="https://mineweb.org" target="blank">MineWeb</a></span></p>
		...
		<p class="grey-text text-lighten-4 right">Version 1.0.0</p>
		</div>
		</div>
